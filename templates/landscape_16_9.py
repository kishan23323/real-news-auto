...
def build_body(W, MID_H, frame_y, image_paths, captions, durations,
    ...
    # the red background there).
    PAD        = max(round(MID_H * 0.045), round(container_radius * 0.7))
    ...
    pill = common.pill_clip(breaking_text, impact_font, headline_size, style.get("breaking_bg", "#8E0E0E"),
    ...
    for caption, dur in zip(captions, durations):
        ...
        cap_clip = common.fit_caption_block(
            common.wrap_caption(caption, max_words=40), HALF_W - 40, yellow_h - 20, font, caption_size, "black",
            min_size=15, align="center",
        )
