...
def marquee_clip(text, font, font_size, color, box_w, box_h, duration, speed=140, align_v="center"):
    ...
    but if the text already fits, it stays static (no scrolling, never
    appears cut off) instead of scrolling unnecessarily."""
...
def build_banners(W, H, TOP_H, BOTTOM_H, total_duration, font, style=None):
    ...
    if circular:
        ...
        logo_clip = load_logo_clip(logo_size, total_duration)
    ...
    headline = marquee_clip(top_text, font, top_text_size, top_text_color, text_w, text_h, total_duration, speed=110)
    ...
    share_text = marquee_clip(bottom_text, font, bottom_text_size, bottom_text_color, share_w, share_h, total_duration, speed=130)
