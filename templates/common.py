...
DEFAULT_STYLE = {
    ...
    # MIDDLE CONTAINER
    "mid_border_width": 0,
    "mid_container_margin":  22,   # outer gap from screen edges
    "mid_container_padding": 0,    # inner gap; 0 = auto (keeps content clear of rounded corners)
    ...
    # CAPTION
    "caption_radius":   12,
    "caption_padding":  20,   # inset between caption box edge and its text
    "caption_margin":   18,   # gap between the BREAKING NEWS pill and the caption box below it
