...
def build_video(image_paths, captions, durations, audio_path, title,
                 ...
                 templates=None, lang="hi", tmp_dir="/tmp", style=None):
    """
    ...
    style:     optional dict overriding banner_color, bottom_color, frame_color,
               logo_position, corner_radius, headline_size, caption_size
               (see templates/common.py DEFAULT_STYLE). Applied to every
               template built in this call.
    ...
    if len(selected) == 1:
        _templates.render(selected[0], image_paths, captions, durations,
                           audio_path, out_path, lang=lang, style=style)
        return out_path
    ...
    for key in selected:
        ...
        _templates.render(key, image_paths, captions, durations,
                           audio_path, this_out, lang=lang, style=style)
...
def default_style():
    return _templates.default_style()
