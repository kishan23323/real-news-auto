...
def build_video(image_paths, captions, durations, audio_path, title,
    ...
    top_headline = _wrapped_text_clip(
        TOP_TEXT_HI, W - logo_w - 50, font, 26, "black", total_duration, align="left",
    )
    ...
    badge_h = int(BOTTOM_H * 0.85)
    badge_clip = _load_badge_clip(220, badge_h, total_duration)
